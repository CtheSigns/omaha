...
set GOROOT=c:\My\Projects\CTheSigns\OmagaTools\go\
...
set OMAHA_PROTOBUF_BIN_DIR=c:\My\Projects\CTheSigns\OmagaTools\protobuf\bin
...
:: C:\protobuf\src.
set OMAHA_PROTOBUF_SRC_DIR=c:\My\Projects\CTheSigns\OmagaTools\protobuf_src\src
...
set OMAHA_WTL_DIR=c:\My\Projects\CTheSigns\OmagaTools\wtl\
...
set SCT_DIR=c:\My\Projects\CTheSigns\OmagaTools\swtoolkit\
